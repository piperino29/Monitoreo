      ...
      return (
        <StyledTableRow hover key={rowIndex} sx={rowStyle}>
          <StyledTableCell align="center">
            {o.numot_vehicular && o.numot_vehicular.toString().slice(9)}
          </StyledTableCell>
          <StyledTableCell align="center">
            {o.numot && o.numot.toString().slice(9)}
          </StyledTableCell>
          <StyledTableCell align="center">
            {o.razonsocial}
          </StyledTableCell>
          ...
          <StyledTableCell align="center">
            {o.fecha_compromiso && o.fecha_compromiso.toString().slice(0,10)}
          </StyledTableCell>
            <StyledTableCell align="center">
              {o.usuarioevaluacion}
            </StyledTableCell>
            ...
            <Table key={i} sx={{ tableLayout: "auto" }}>
              <TableHead>
                <TableRow>
                  ...
                  <StyledTableCell align="center">OT Componente</StyledTableCell>
                  <StyledTableCell align="center">Cliente</StyledTableCell>
                  <StyledTableCell align="center">Componente</StyledTableCell>
                  <StyledTableCell align="center">Tiempo</StyledTableCell>
                  <StyledTableCell align="center">Fecha De Compromiso</StyledTableCell>
